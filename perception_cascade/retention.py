...
FINAL_READ_PROMPT = config.load_prompt("CASCADE_FINAL_READ_PROMPT", _FINAL_READ_PROMPT_DEFAULT)
...
_FINAL_READ_PROMPT_DEFAULT = """Final evening scan of a TZ Pro echogram frame that was
